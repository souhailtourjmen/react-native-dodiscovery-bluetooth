 ...
 *
 */
- (void)scanDeviceAtLAN:(NSTimeInterval)timeout;

/**
 *  \~chinese
 *
 *  发送广播消息，解决iOS14+的系统收不到广播问题
 *
 *  \~english
 *
 *  Send broadcast messages to solve the problem that the system of iOS14+ cannot receive broadcasts
 *
 */
 ...
 *  \~english
 *
 *  Stop searching for devices in the local area network
 *
 */
- (void)stopScanAtLAN;
